...
import { AncestryTimeline } from '../components/AncestryTimeline';
...
export default async function AncestryPage() {
  ...
  return (
    <Suspense fallback={<div className="flex justify-center items-center min-h-screen">Loading ancestry data...</div>}>
      <AncestryTimeline 
