...
export function PeriodRegionsClient({ period, allRegions, allEvents, allPeople, timelinePeriods, eventLocationNames, dataMinYear, dataMaxYear }: PeriodRegionsClientProps) {
